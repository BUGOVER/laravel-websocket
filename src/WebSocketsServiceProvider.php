...
use BeyondCode\LaravelWebSockets\Manager\ManagerProvider;
...
class WebSocketsServiceProvider extends ServiceProvider
{
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../database/migrations/0000_00_00_000000_create_websockets_statistics_entries_table.php' => database_path(
                'migrations/0000_00_00_000000_create_websockets_statistics_entries_table.php'
            ),
        ], 'migrations');
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(ChannelManager::class, function ($app) {
            ...
            return null !== ($config['channel_manager'] ?? null) && class_exists($config['channel_manager'])
